  ...
  showOverlay() {
    ...
    if (isPhone && this.isPortrait) {
      ...
      recommendations = [
        ...
        "📊 Cipher tables and key matrices display better horizontally",
      ];
      ...
      recommendations = [
        ...
        "🔍 Zoom controls may help with small cipher elements",
      ];
      ...
      <div class="mobile-overlay-backdrop">
        <div class="mobile-overlay-content">
          ...
          <div class="mobile-overlay-crypto-info">
            <strong>🔐 Vernam Cipher Simulation Features:</strong>
            <ul class="mobile-overlay-crypto-list">
              <li>• Interactive One-Time Pad encryption/decryption</li>
              <li>• Educational scenarios with security analysis</li>
              <li>• Key generation and perfect secrecy demonstrations</li>
              <li>• Binary/text XOR operations visualization</li>
              <li>• Attack simulation and vulnerability testing</li>
            </ul>
          </div>
          ...
          <p class="mobile-overlay-footer">
            💡 Tip: For the best cryptography learning experience with Vernam Cipher, use a desktop or tablet in landscape mode.
          </p>
        </div>
      </div>
    `;
